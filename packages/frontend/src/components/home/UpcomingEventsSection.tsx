  ...
  if (isLoading) {
    return (
      <section aria-labelledby="upcoming-events-heading">
        <h2 id="upcoming-events-heading" className="text-3xl font-bold text-dark mb-6">
  ...
  return (
    <section aria-labelledby="upcoming-events-heading">
      <div className="flex items-center justify-between mb-6">
        <h2 id="upcoming-events-heading" className="text-3xl font-bold text-dark">
          {t('home.upcomingEvents.title', 'Upcoming Events')}
        </h2>
        <Link
          to="/events"
        ...
        {events.map((event) => {
          ...
          return (
            <Link
              ...
              className="group block bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
            >
              {/* Event Image */}
              <div className="h-40 bg-gray-100 relative overflow-hidden">
                ...
                {/* Date badge overlay */}
                <div className="absolute top-3 left-3 bg-white rounded-lg shadow-md px-3 py-2 text-center">
              ...
              {/* Event Info */}
              <div className="p-4">
                <h3 className="text-lg font-semibold text-gray-900 mb-1 line-clamp-1 group-hover:text-primary transition-colors">
                  {event.title}
                </h3>
                ...
                {event.category && (
                  <p className="text-sm text-gray-500 mb-2">
                    {event.category.icon} {event.category.name.en || Object.values(event.category.name)[0]}
                  </p>
                )}
