...
### Users & Core Entities
7. [User Types & Roles](#7-user-types--roles)
8. [Business Profile Features](#8-business-profile-features)
9. [Community User Features](#9-community-user-features)
10. [Business Owner Features](#10-business-owner-features)

### Core Functionality
11. [Search & Discovery](#11-search--discovery)
12. [Events & Calendar System](#12-events--calendar-system)
13. [Messaging & Communication System](#13-messaging--communication-system)
14. [Deals & Promotions Hub](#14-deals--promotions-hub)

### Community & Social Features
15. [Community Features](#15-community-features)
16. [Social Media Integration](#16-social-media-integration)
17. [Business-to-Business Networking](#17-business-to-business-networking)
18. [Emergency & Crisis Communication](#18-emergency--crisis-communication)

### Administration & Operations
19. [Administration & Moderation](#19-administration--moderation)
...
| `AWS_S3_BUCKET` | S3 bucket name | `guildford-platform-media` |
...
## 8. Business Profile Features

### 8.1 Basic Business Information
...
### 8.5 Language & Cultural Features
...
## 10. Business Owner Features

### 10.1 Business Claim & Verification
...
- Business must be physically located within the configured precinct boundary
...
|---------|-----------------|
| Basic Info | All fields from Section 8.1 |
| Hours | All fields from Section 8.2 |
| Media | All fields from Section 8.3 |
| Social Links | All fields from Section 8.4 |
| Languages | All fields from Section 8.5 |
| Promotions | All fields from Section 8.6 |
...
|---------|---------------|
| Page Title | "{Business Name} - {Category} in {Suburb}" |
...
### 13.7 Business Messaging Analytics
...
### 14.6 Personalised Deal Recommendations
...
### 15.5 Local History Archive

#### Content Types

| Type | Description |
|---------|-------------|
| Historical Photos | Images from the area's past |
...
|---------|----------|-------------|
| Primary hashtag | Instagram, Facebook, X | Primary community hashtag (configurable) |
| Secondary hashtags | Instagram, Facebook, X | Additional location hashtags |
...
| Filter | Description |
|--------|-------------|
| Location | Posts geotagged within configured radius |
...
| Off-topic | Flag posts not related to the area |
...
## 17. Business-to-Business Networking
...
| Years in Area | Number | Time operating in precinct |
| Industry Connections | Multi-select | Industries interested in connecting with |

### 17.3 Business Directory (B2B View)
...
### 17.7 Business Community Features
...
## 18. Emergency & Crisis Communication

### 18.1 Overview

A critical communication system for urgent alerts affecting the community, ensuring residents and businesses receive timely notifications during emergencies.
...
| Council | All levels | No (trusted source) |
| State Government | Critical, Warning | No (integrated feed) |
...
| Affected Area | Multi-select | Yes | Specific suburbs/streets or "All" |
...
### 18.7 Business Emergency Features
...
### 18.8 Community Safety Features
...
| System | Integration |
|--------|-------------|
| State Alerts | Feed integration for relevant alerts |
| Bureau of Meteorology | Severe weather warnings |
| Transport Authority | Major transport disruptions |
| Council Systems | Direct integration for council alerts |

---

## 19. Administration & Moderation
...
### 20.2 Business Analytics

See Section 10.4 for business-specific analytics.
...
### 21.1 Google Business Profile API
